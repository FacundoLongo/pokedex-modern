export default function NavBar(props) {
   return (
      <header
         ...
         class="sticky top-0 z-20 w-full px-2 py-2 bg-white sm:px-3 shadow-md"
      >
         <div class="mx-auto flex h-16 max-w-screen-2xl items-center justify-between sm:px-6 lg:px-8 ">
            <div class="flex items-center">
               <a href="#" class="flex">
                  <h2 class="px-4 font-bold text-lg">Pokedex</h2>
               </a>
            </div>
               ...
               <div class="ml-8 flex items-center">
                  <div class="flex items-center ">
                     <span>
                        <a
                           href="#"
                           class="block border-b-4 border-transparent p-4 "
                           style={{ marginTop: '5px' }}
                        >
                           <svg
